...
/**
 * @brief Creates a new node of the specified type and initializes it
 * 
...
/**
 * @brief Sets the string value of a node
 * 
...
/**
 * @brief Frees the memory occupied by a node and its children
 * 
